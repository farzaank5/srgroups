...
class _AllBookingsWidgetState extends State<AllBookingsWidget>
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AllBookingsModel());
  ...
  Widget build(BuildContext context) {
    ...
    return StreamBuilder<List<TotalBookingRecord>>(
      ...
      builder: (context, snapshot) {
        ...
        List<TotalBookingRecord> allBookingsTotalBookingRecordList =
            snapshot.data!;
              ...
              child: SingleChildScrollView(
                child: Column(
                  ...
                  children: [
                    ...
                    Builder(
                      builder: (context) {
                        final allbookings = allBookingsTotalBookingRecordList
                            .map((e) => e)
                            .toList();
                                            ...
                                            child: Padding(
                                              ...
                                              child: Row(
                                                ...
                                                children: [
                                                  ...
                                                  Flexible(
                                                    child: Text(
                                                      '₹ ${allbookingsItem.price.toString()}',
                                                      style: FlutterFlowTheme
                                                              .of(context)
                                                          .titleLarge
                                                          .override(
