...
class AddedvillasdetailsWidget extends StatefulWidget {
  const AddedvillasdetailsWidget({
    super.key,
...
class _AddedvillasdetailsWidgetState extends State<AddedvillasdetailsWidget> {
  late AddedvillasdetailsModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AddedvillasdetailsModel());
                          ...
                          Align(
                            ...
                            child: Padding(
                              ...
                              child: ClipRRect(
                                ...
                                child: Image.network(
                                  addedvillasdetailsVillasRecord.phoUrl,
                                  width: 421.0,
                                  height: 239.0,
                                  fit: BoxFit.cover,
                                ),
                              ...
                              children: [
                                Padding(
                                  padding: const EdgeInsetsDirectional.fromSTEB(
                                      23.0, 12.0, 0.0, 0.0),
                                  child: Text(
                                    addedvillasdetailsVillasRecord.displayName,
                      ...
                      Padding(
                        ...
                        child: Row(
                          ...
                          children: [
                            ...
                            Text(
                              formatNumber(
                                addedvillasdetailsVillasRecord.price,
                          ...
                          fieldViewBuilder: (
                            ...
                            return TextFormField(
                              ...
                              decoration: InputDecoration(
                                ...
                                hintText:
                                    addedvillasdetailsVillasRecord.placeRef,
                                hintStyle:
                                    FlutterFlowTheme.of(context).labelMedium,
                          ...
                          child: FFButtonWidget(
                            onPressed: () async {
                              await widget.placeRef!
                                  .update(createVillasRecordData(
                                placeRef: _model.textController.text,
                              ));
                              ScaffoldMessenger.of(context).clearSnackBars();
                              ScaffoldMessenger.of(context).showSnackBar(
                                SnackBar(
                                  content: Text(
                                    'Villa ID succesfully updated',
                                    style: FlutterFlowTheme.of(context)
                                        .titleSmall
                                        .override(
